...
public class NewsService {
	...
	public String articleNumberByMonthInAYear(String year, HttpServletRequest request){
		...
		try{
			...
			String excelFile="\\"+WebProperties.config.getString("projectName")+WebProperties.config.getString("excelTemplate")+"\\articleNumberByMonthInAYear.xlsm";
	...
	public String articleNumberByMonthInAYearEveryYear(HttpServletRequest request){
		...
		try {
			...
			for(ArticleNumberByMonthInAYear ArticleNumberByMonthInAYear: articleNumberByMonthInAYearEveryYearList){
				...
				jacobWordManager.goToBegin();
				jacobWordManager.replaceText("#averageByMonth", ""+Tool.formatDouble(ArticleNumberByMonthInAYear.getTotalNewsNumber()*1.0/12).toString());
			...
			wordFile="\\"+WebProperties.config.getString("projectName")+WebProperties.config.getString("wordTemplate")+"\\articleNumberByMonthInAYearEveryYearAll.docm";
